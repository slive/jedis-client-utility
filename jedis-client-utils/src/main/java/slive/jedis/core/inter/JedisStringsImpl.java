...
import slive.jedis.core.JedisStrings;
...
public final class JedisStringsImpl extends JedisKeysImpl implements JedisStrings {
    ...
    public <T> T getset(String key, T newPojoObject) {
        ...
        String newVal = slive.jedis.util.PojoJsonUtils.convert2String(newPojoObject);
        String ret = jedis.getSet(key, newVal);
        if (ret != null) {
            if (isString) {
                return (T) ret;
            }
            return (T) slive.jedis.util.PojoJsonUtils.convert2Object(ret, newPojoObject.getClass());
        }
        return null;
    }
    ...
    public <T> List<T> mget(Class<T> pojoClazz, String... keys) {
        ...
        if (mget != null) {
            return slive.jedis.util.PojoJsonUtils.convert2ObjectList(mget, pojoClazz);
        }
        return Collections.EMPTY_LIST;
    }
    ...
    public boolean setex(String key, int seconds, Object pojoObject) {
        ...
        String setVal = slive.jedis.util.PojoJsonUtils.convert2String(pojoObject);
