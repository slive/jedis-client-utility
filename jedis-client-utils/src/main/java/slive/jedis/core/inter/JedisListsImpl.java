...
import slive.jedis.core.JedisLists;
...
public final class JedisListsImpl extends JedisKeysImpl implements JedisLists {
    ...
    public <T> long lpush(String key, T... values) {
        ...
        int index = 0;
        for (T t : values) {
            str[index++] = slive.jedis.util.PojoJsonUtils.convert2String(t);
        }
    ...
    public <T> long lrem(String key, long count, T value) {
        ...
        return jedis.lrem(key, count, slive.jedis.util.PojoJsonUtils.convert2String(value));
    }
    ...
    public <T> boolean lset(String key, long index, T value) {
        ...
        return RET_OK_STR.equals(jedis.lset(key, index, slive.jedis.util.PojoJsonUtils.convert2String(value)));
    }
