...
import slive.jedis.core.JedisSortSets;
...
public final class JedisSortSetsImpl extends JedisKeysImpl implements JedisSortSets {
    ...
    public long zadd(String key, double score, Object member) {
        ...
        String val = slive.jedis.util.PojoJsonUtils.convert2String(member);
    ...
    public <T> long zadd(String key, Map<T, Double> members) {
        ...
        for (Entry<T, Double> e : entrySet) {
            vals.put(slive.jedis.util.PojoJsonUtils.convert2String(e.getKey()), e.getValue());
        }
    ...
    public <T> Set<T> zrange(String key, long start, long end, Class<T> pojoClazz) {
        ...
        for (String s : ret) {
            retList.add(slive.jedis.util.PojoJsonUtils.convert2Object(s, pojoClazz));
        }
        return retList;
    }
    ...
    public long zrank(String key, Object member) {
        ...
        Long zrank = jedis.zrank(key, slive.jedis.util.PojoJsonUtils.convert2String(member));
    ...
    public Double zscore(String key, Object member) {
        ...
        Double zrank = jedis.zscore(key, slive.jedis.util.PojoJsonUtils.convert2String(member));
        return zrank != null ? zrank : DEFAULT_VAL_INT;
    }
